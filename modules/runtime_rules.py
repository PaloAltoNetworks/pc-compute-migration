...
def migrate(dst_session, src_session_list, options, logger):
    generic_pull_put_migrate.g_migrate(dst_session, src_session_list, 'Runtime Rules - Container', '/api/v1/policies/runtime/container', 'name', 'rules', logger, translate_custom_rule_ids=True)
