...
def g_migrate(dst_session, src_session_list, module, endpoint, name_index, data_index, single_mode, logger, col_dep=True, tag_dep=False, skip='', skip_value='', data_index2='', verb_overwrite='POST'):
    #Const
    MODULE = module
